...
from utils.math import qvec2rotmat, rotmat2qvec
from utils.loss import l1dep_loss
...
def eval_rendering_mapping(
    ...
    Log(f'mean psnr: {output["mean_psnr"]}, ssim: {output["mean_ssim"]}, lpips: {output["mean_lpips"]}', tag="    mapping results")
